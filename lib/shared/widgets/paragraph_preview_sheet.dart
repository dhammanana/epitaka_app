...
/// Shows a modal bottom sheet with Pāli + translation preview content,
/// styled consistently with the reader's typography settings.
///
/// Used by:
/// - [BookLinkSectionSheet] (tapping a book-link chip in the reader)
/// - Search result preview (long-pressing a search result item)
///
/// Supports double-tap on Pāli text to open the dictionary.
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  // Action button (e.g. "Open in Reader")
              ...
              child: lines.isEmpty
                  ...
                  : SingleChildScrollView(
                      ...
                      child: PreviewContent(
                        lines: lines,
                        highlightParaId: highlightParaId,
                        firstSnippetIndex: firstSnippetIndex,          paliSnippet: paliSnippet,
          onPaliWordTap: (word) {
                          showDictionarySheet(context, word);
                        },
                      ),
                    ),
            ),
